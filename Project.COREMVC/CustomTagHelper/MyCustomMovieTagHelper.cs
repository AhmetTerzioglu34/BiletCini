...
namespace Project.COREMVC.CustomTagHelpers
{
    ...
    public class MyCustomMovieTagHelper : TagHelper
    {
        readonly ICategoryManager _categoryManager;
        readonly IMovieCategoryManager _movieCategoryManager;

        public MyCustomMovieTagHelper(ICategoryManager categoryManager, IMovieCategoryManager movieCategoryManager)
        {
