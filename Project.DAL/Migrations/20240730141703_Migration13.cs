    ...
    public partial class Migration13 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionMovies", x => new { x.MovieID, x.SessionID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionTickets", x => new { x.SessionID, x.TicketID });
                    table.ForeignKey(
                        name: "FK_SessionTickets_Sessions_SessionID",
                        column: x => x.SessionID,
                        principalTable: "Sessions",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SessionTickets_Tickets_TicketID",
                        column: x => x.TicketID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Screens_Places_PlaceID",
                        column: x => x.PlaceID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionScreens", x => new { x.SessionID, x.ScreenID });
                    table.ForeignKey(
                        name: "FK_SessionScreens_Screens_ScreenID",
                        column: x => x.ScreenID,
                        principalTable: "Screens",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SessionScreens_Sessions_SessionID",
                        column: x => x.SessionID,
                        principalTable: "Sessions",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "5cf365b2-aa69-4cee-aee9-c344ef65270c", new DateTime(2024, 7, 30, 17, 17, 2, 987, DateTimeKind.Local).AddTicks(4905), null, null, "Admin", "ADMIN", 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, null, "ddcc8df0-f7bc-4a15-8166-e2c5c3226a84", new DateTime(2024, 7, 30, 17, 17, 2, 987, DateTimeKind.Local).AddTicks(5144), null, "ahmet@gmail.com", true, false, null, null, "AHMET@GMAIL.COM", "AHMET123", "AQAAAAIAAYagAAAAEBUmHJkrJkRINZCVqpv02WwiKWZDUwgWjmBePEfsjKYrKsRjjXvtZB67hFfO4P+UnQ==", null, false, "f6d3cd98-a128-4d26-afd2-a6611ef9bb63", 1, false, "ahmet123" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId", "CreatedDate", "DeletedDate", "ModifiedDate", "Status" },
                values: new object[] { 1, 1, new DateTime(2024, 7, 30, 17, 17, 3, 55, DateTimeKind.Local).AddTicks(6753), null, null, 1 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionScreens_ScreenID",
                table: "SessionScreens",
                column: "ScreenID");

            migrationBuilder.CreateIndex(
                name: "IX_SessionTickets_TicketID",
